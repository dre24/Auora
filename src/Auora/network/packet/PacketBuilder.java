 ...
 * MessageBuilder.java
 * 
 * @author Harry Andreas RuneCore 8 Aug 2011
 */
public class PacketBuilder {
	...
	public PacketBuilder(int opcode) {
		this(opcode, Packet.PacketType.STANDARD);
	}
	...
	public Packet build() {
		return new Packet(opcode, type, ChannelBuffers.copiedBuffer(buffer));
	}
	...
	public PacketBuilder putGJString(String s) {
		writeByte(0);
