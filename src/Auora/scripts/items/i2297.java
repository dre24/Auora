...
public class i2297 extends itemScript {
    ...
    public void option1(Player p, int itemId, int interfaceId, int slot) {
        ...
        p.getInventory().deleteItem(2297, 1, slot);
        p.getInventory().addItem(2301, 1, slot);
        p.animate(829);
        p.getSkills().heal(90);
        ...
        p.getFrames().sendChatMessage(0, "You eat the Anchovy pizza.");
    }
