...
public class i15324 extends itemScript {
    ...
    public void option1(Player p, int itemId, int interfaceId, int slot) {
        ...
        p.getInventory().deleteItem(15324, 1, slot);
        p.getInventory().addItem(15325, 1, slot);
        p.getSkills().set(Skills.RANGE, p.getSkills().getLevelForXp(Skills.RANGE) + 5 + Math.round(p.getSkills().getLevelForXp(Skills.RANGE) * 15 / 100));
        p.animate(829);
