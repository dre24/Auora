...
public class i4421 extends itemScript {
    ...
    public void option1(Player p, int itemId, int interfaceId, int slot) {
        ...
        p.getInventory().deleteItem(4421, 1, slot);
        p.getInventory().addItem(4423, 1, slot);
        p.animate(829);
        p.getSkills().heal(50);

        p.getCombatDefinitions().setLastPot(System.currentTimeMillis() + 1800);
        p.getFrames().sendChatMessage(0, "You drink Guthix rest (2).");
    }
