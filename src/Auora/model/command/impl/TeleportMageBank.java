 ...
 * @author Jonny
 */
public class TeleportMageBank extends Command {

    public TeleportMageBank(StaffRights staffRights, DonatorRights donatorRights, boolean safeOnly) {
    ...
    public void execute(Player p, String[] args, StaffRights privilege) {
        ...
        GameServer.getEntityExecutor().schedule(new Task() {
            ...
            public void run() {
                p.animate(8941);
                p.getMask().getRegion().teleport(2539, 4716, 0, 0);
            }
        }, 1801);
    }
}
