 ...
 * @author Jonny
 */
public class TeleportEdgeville extends Command {

    public TeleportEdgeville(StaffRights staffRights, DonatorRights donatorRights, boolean safeOnly) {
    ...
    public void execute(Player p, String[] args, StaffRights privilege) {
        ...
        GameServer.getEntityExecutor().schedule(new Task() {
            ...
            public void run() {
                p.animate(8941);
                p.getMask().getRegion().teleport(3086, 3502, 0, 0);
            }
        }, 1801);
    }
}
