...
public class UnMutePlayer extends Command {
    ...
    public UnMutePlayer(StaffRights staffRights, DonatorRights donatorRights, boolean safeOnly) {
    ...
    public void execute(Player p, String[] args, StaffRights privilege) {
        ...
        if (other != null) {
            other.sendMessage("You have been un-muted.");
        }
        p.getFrames().sendMessage("You have un-muted " + name + ".");
