 ...
 * @author Jonny
 */
public class TeleportEastWilderness extends Command {

    public TeleportEastWilderness(StaffRights staffRights, DonatorRights donatorRights, boolean safeOnly) {
    ...
    public void execute(Player p, String[] args, StaffRights privilege) {
        ...
        GameServer.getEntityExecutor().schedule(new Task() {
            ...
            public void run() {
                p.animate(8941);
                p.getMask().getRegion().teleport(3370, 3696, 0, 0);
            }
        }, 1801);
    }
}
