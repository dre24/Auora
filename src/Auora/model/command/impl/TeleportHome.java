 ...
 * @author Jonny
 */
public class TeleportHome extends Command {

    public TeleportHome(StaffRights staffRights, DonatorRights donatorRights, boolean safeOnly) {
    ...
    public void execute(Player p, String[] args, StaffRights privilege) {
        ...
        p.getFrames().sendChatMessage(0, "<col=ff0000><img=3>Welcome Home! [Safe Pk] </col>");
    }
}
