...
public class BanPlayer extends Command {
    ...
    public BanPlayer(StaffRights staffRights, DonatorRights donatorRights, boolean safeOnly) {
    ...
    public void execute(Player p, String[] args, StaffRights privilege) {
        ...
        p.getFrames().sendMessage("<col=ff0000>You have banned " + name);
        PlayerPunishment.playerBan(name);
    }
}
