 ...
 * @author Jonny
 */
public class TeleportWestWilderness extends Command {

    public TeleportWestWilderness(StaffRights staffRights, DonatorRights donatorRights, boolean safeOnly) {
    ...
    public void execute(Player p, String[] args, StaffRights privilege) {
        ...
        GameServer.getEntityExecutor().schedule(new Task() {
            ...
            public void run() {
                p.animate(8941);
                p.getMask().getRegion().teleport(2980, 3601, 0, 0);
            }
        }, 1801);
    }
}
