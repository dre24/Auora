 ...
 * @author Jonny
 */
public class ClanWarsTeleport extends Command {

    public ClanWarsTeleport(StaffRights staffRights, DonatorRights donatorRights, boolean safeOnly) {
    ...
    public void execute(Player p, String[] args, StaffRights privilege) {
        ...
        p.getFrames().sendChatMessage(0, "<col=ff0000><img=3>Welcome to Clanwars! [Multi/UnSafe Pk] </col>");
    }
}
